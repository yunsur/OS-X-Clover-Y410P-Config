...
DefinitionBlock("", "SSDT", 2, "Y410P", "EH02", 0)
{
    ...
    If (CondRefOf(_SB.PCI0.EH02))
    {
        Method(_SB.PCI0.EH02._DSM, 4)
        {
            ...
            Return (Package()
            {
                ...
                "name", Buffer () {"Intel Lynx Point PCH - USB 2.0 EHCI Host Controller 2"},
                "model", Buffer () {"Intel Lynx Point PCH - USB 2.0 EHCI Host Controller 2"},
