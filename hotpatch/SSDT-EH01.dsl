...
DefinitionBlock("", "SSDT", 2, "Y410P", "EH01", 0)
{
    ...
    If (CondRefOf(_SB.PCI0.EH01))
    {
        Method(_SB.PCI0.EH01._DSM, 4)
        {
            ...
            Return (Package()
            {
                ...
                "name", Buffer () {"Intel Lynx Point PCH - USB 2.0 EHCI Host Controller 1"},
                "model", Buffer () {"Intel Lynx Point PCH - USB 2.0 EHCI Host Controller 1"},
